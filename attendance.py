...
class Attendance:
    def __init__(self, root):
        ...
        img = img.resize((500, 200), Image.LANCZOS) # Changed from ANTIALIAS to LANCZOS
        ...
        #second image 
        img1 = Image.open(r"college_images\attend1.jpg")
        img1 = img1.resize((500, 200), Image.LANCZOS) # Changed from ANTIALIAS to LANCZOS
        ...
        main_frame.place(x=20,y=45,width=1300,height=600)

         # left label frame
        
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text=" Student Attendance Detalis",font=("times new roman",12,"bold",))
        Left_frame.place(x=10,y=10,width=620,height=580)

        img_left = Image.open(r"college_images\student.jpg")
        ...
        reset_btn.grid(row=0,column=3,)
         # right side frame
        Right_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Attendance management system",font=("times new roman",12,"bold",))
        Right_frame.place(x=620,y=15,width=620,height=480)

        table_frame=Frame(Right_frame,bd=2,relief=RIDGE,bg="white")
        table_frame.place(x=5, y=5, width=600, height=390)
